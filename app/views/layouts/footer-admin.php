<footer class="footer text-center"> 2021 © BliRumah</footer>
</div>
</div>
<!-- Bootstrap -->
...
<script src="<?= baseurl ?>/assets/admin-assets/plugins/bower_components/jquery-sparkline/jquery.sparkline.min.js">
</script>
<!--Wave Effects -->
