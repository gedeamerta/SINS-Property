<div class="container">
    <div class="row mt-5">
        <div class="col-8">
            ...
            <div class="mt-3">
                <h5 class="<?= $data['property_single']['purchased'] == 'sold' ? 'text-danger' : 'text-success' ?>">
                    <?= $data['property_single']['purchased'] == 'sold' ? 'Sold' : 'Available' ?></h5>
                ...
                <?php if ($data['property_single']['purchased'] == 'sold') : ?>
                <p class="text-danger">Can't contact now. You can check later</p>
                <?php else : ?>
        ...
        <div class="col-4">
            <div>
                ...
                <div data-aos="zoom-out-up" data-aos-delay="<?= $increment += 100 ?>" class="card mb-3">
                    ...
                    <div class="card-body">
                        <h5 class="<?= $property['purchased'] == 'sold' ? 'text-danger' : 'text-success' ?>">
                            <?= $property['purchased'] == 'sold' ? 'Sold' : 'Available' ?></h5>
