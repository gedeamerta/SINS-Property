...
class Agent extends Controller 
{
    ...
    {
        if ($this->model('Agent_model')->purchased($id) > 0) {
            Flasher::setFlash('success', 'Success Changes Status Property');
            header("Location: " . baseurl . "/agent/details/$id");
        } else {
            Flasher::setFlash('error', 'Fails Changes Status Property');
            header("Location: " . baseurl . "/agent/details/$id");
        }
    }
