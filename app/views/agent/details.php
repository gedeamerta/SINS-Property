    ...
    <div class="row mt-5">
        <div class="col-8">
            ...
            <div class="mt-3">
                ...
                <form method="post" action="<?= baseurl; ?>/agent/purchased/<?= $data['property_single']['id'] ?>">
                    <div class="col-6">
                        <select class="form-select form-select-lg mb-3" aria-label=".form-select-lg example"
                            name="purchased">
                            <option selected disabled>Status Property</option>
            ...
            <div>
                ...
                <div data-aos="zoom-out-up" data-aos-delay="<?= $increment += 100 ?>" class="card mb-3">
                    ...
                    <div class="card-body">
                        ...
                        <a href="<?= baseurl; ?>/agent/details/<?= $property['id'] ?>"
